-- Mailbox RPC hardening:
-- 1) cutoff by approved_at/created_at (default)
-- 2) optional include-before-approval override
-- 3) keep 6-arg compatibility wrapper for existing frontend calls
